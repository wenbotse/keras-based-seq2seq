...
#input token dict
input_token_index_pkl_file = open('input_token_index.pkl','rb')
input_token_index = pickle.load(input_token_index_pkl_file)
input_token_index_pkl_file.close()
print('input dict size='+str(len(input_token_index)))


#target token dict
target_token_index_pkl_file = open('target_token_index.pkl','rb')
target_token_index = pickle.load(target_token_index_pkl_file)
target_token_index_pkl_file.close()
print('target dict size='+str(len(target_token_index)))

num_decoder_tokens = len(target_token_index)


encoder_input_data = np.zeros(
    (len(input_texts), max_encoder_seq_length, len(input_token_index)),
    dtype='float32')
